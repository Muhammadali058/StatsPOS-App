...
fun salesBillWiseReport(
    context: Context,
    fromDate: String,
    toDate: String,
    billWiseReport: List<SalesBillWiseReport>,
...
//        }
    ...
    billWiseReport.forEach { item ->
        ...
        bodyTable.addCell(
            Cell().add(Paragraph(item.salesOn).setFontSize(REPORT_BODY_FONT_SIZE))
                .setTextAlignment(TextAlignment.CENTER)
        )

        bodyTable.addCell(
            Cell().add(Paragraph(item.salesType).setFontSize(REPORT_BODY_FONT_SIZE))
                .setTextAlignment(TextAlignment.CENTER)
        )
        ...
        bodyTable.addCell(
            Cell().add(Paragraph(item.isRetail).setFontSize(REPORT_BODY_FONT_SIZE))
                .setTextAlignment(TextAlignment.CENTER)
        )
