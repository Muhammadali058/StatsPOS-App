...
import com.graphees.statspos.presentation.viewmodels.sales.sales_bill.AddUpdateSalesItemViewModel
...
fun AddUpdateSalesItemScreen(
    ...
    val crtnFocusRequester = remember { FocusRequester() }
            ...
            Column(
                ...
                Column(
                    ...
                    SearchItemBox(
                        ...
                        onItemSelected = {
                            viewModel.getItem(it) { item ->
                                if (item.crtnSize == 1) {
                                    crtnFocusRequester.requestFocus()
                                } else {
                                    qtyFocusRequester.requestFocus()
                                }
                            }
...
//                            keyboardController?.hide()
                    ...
                    Body(
                        ...
                        crtnFocusRequester = crtnFocusRequester,
                        qty = state.qty,
                        crtn = state.crtn,
                        rate = state.rate,
...
private fun Body(
    ...
    crtnFocusRequester: FocusRequester? = null,
    qty: String,
    crtn: String,
    rate: String,
    crtnRate: String,
