package com.graphees.statspos.presentation.viewmodels.accounts.entries.stock
...
@HiltViewModel
class StockEntriesViewModel @Inject constructor(
    ...
    fun loadEntries() {
        viewModelScope.launch {
            ...
            val params = JsonObject().apply {
                addProperty("entryType", getEntryType(EntryType.STOCK))
